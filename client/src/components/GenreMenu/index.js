...
const filters = [
    {
        ...
        name: 'Genre',
        options: [
            { value: '0', name: 'Rock', checked: false },
            { value: '1', name: 'Hip-Hop', checked: false },
            { value: '2', name: 'Indie', checked: true },
            { value: '3', name: 'Electronic', checked: false },
            { value: '4', name: 'Jazz', checked: false },
            { value: '5', name: 'Folk', checked: false },
            { value: '6', name: 'Country', checked: false },
            { value: '7', name: 'Soul', checked: false },
            { value: '8', name: 'Funk', checked: false },
            { value: '9', name: 'Dub/Raggae', checked: false },
