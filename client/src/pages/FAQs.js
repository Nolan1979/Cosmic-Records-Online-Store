...
const Faq1 = () => {
    ...
    return (
        ...
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
            <h2 className=" font-semibold lg:text-4xl text-3xl lg:leading-9 md:leading-7 leading-9 text-green">Frequently Asked Questions</h2>
            <div className="mt-4 flex md:justify-between md:items-start md:flex-row flex-col justify-start items-start">
                <div className=" ">
                    <p className=" font-normal text-base leading-6 text-green lg:w-8/12 md:w-9/12 ">Here are few of the most frequently asked questions by our valueable customers</p>
                </div>
            </div>
                ...
                <div className=" md:w-7/12 lg:w-8/12 w-full md:mt-0 sm:mt-14 mt-10">
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-green">Shipping</h3>
                            <button aria-label="too" className="cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green   " onClick={() => setShow(!show)}>
                        ...
                        <p className={"font-normal text-base leading-6 text-green mt-4 w-11/12 " + (show ? "block" : "hidden")}>We are covering every major country worldwide.<br></br> The shipment leaves from US as it is our headquarter.<br></br><br></br>Shipping and Payment Terms<br></br>
...
PAYMENT IS EXPECTED WITHIN FIVE DAYS UNLESS PRIOR ARRANGEMENT IS MADE.<br></br><br></br> POSTAGE RATES: <br></br>Buyer pays shipping.<br></br><br></br> Please note that as of January 17th 2016 postage rates for shipping outside of the USA have increased significantly. <br></br><br></br>We combine shipping for multiple items <br></br><br></br>USA <br></br>Cassettes $3 / $0.50 each additional <br></br>CDs $3 / $0.50 each additional <br></br>7"s $3.50 / $0.50each additional <br></br>LPs $4.50 plus $1 each additional <br></br><br></br>INTERNATIONAL RATES VARY BY WEIGHT <br></br><br></br>AVERAGE WEIGHT (Including packaging) <br></br>Cassette 3 oz <br></br>Compact Disc 4 oz <br></br>7" Record 6 oz <br></br>12" Record 20 oz <br></br><br></br>CANADA <br></br>1 oz up to 8 oz $10 <br></br>9 oz up to 32 oz $16 <br></br>36 oz up to 48 oz $25<br></br> 52 oz up to 64 oz $36 
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-green">Returns</h3>
                            <button aria-label="too" className=" cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green  " onClick={() => setShow2(!show2)}>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className={"font-normal text-base leading-6 text-green mt-4 w-11/12 " + (show2 ? "block" : "hidden")}>If you would like to make a return, take a look at our policies below. We want to make sure you’re completely happy with your purchase. If there’s anything we can do to improve your experience, please contact us at <br></br><br></br><a href = "mailto: cosmicjanitorhtx@gmail.com" id="linkId">cosmicjanitorhtx@gmail.com</a><br></br><br></br>
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-green">Exchange</h3>
                            <button aria-label="too" className=" cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green  " onClick={() => setShow3(!show3)}>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-green">Refunds</h3>
                            <button aria-label="too" className=" cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green  " onClick={() => setShow4(!show4)}>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className={"font-normal text-base leading-6 text-green mt-4 w-11/12 " + (show4 ? "blcok" : "hidden")}>Once we receive your returned item, our team will review your request and inspect the item. We will send you an email to confirm that we’ve received your item and are processing your request. We’ll follow up with another email once the request has been processed to let you know if your return was approved.<br></br><br></br>
