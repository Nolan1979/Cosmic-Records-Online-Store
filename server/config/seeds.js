...
db.once('open', async () => {
    ...
    const products = await Product.insertMany([
        ...
        {
            title: 'Parliament - Trombipulation',
            genre: genre[8]._id,
            description:
                'Trombipulation is a 1980 album by the funk band Parliament',
            image: 'https://res.cloudinary.com/cosmic-records/image/upload/v1635621911/cosmic%20records/Trombipulation_xfynlo.jpg',
            price: 30.00,
            quantity: 1
        },
    ]);
